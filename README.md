...
19. ### What is async and await. What does a async function return?
     ...
     Async functions enable us to write promise based code as if it were synchronous, but without blocking the execution          thread by operating asynchronously via the event-loop.
